        ...
        RRoundedContainer(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  const RSectionHeading(text: "Variation",showActionButton: false,),
                  const SizedBox(
                    width: RSizes.md,
                  ),
                  ...
                  Column(
                    children: [
                      ...
                      Row(
                        children: [
                          const RProductTitleText(title: "Stack:  ",smallSize: true,),
              ...
              const RProductTitleText(title: "This is the Description of the Product and it can go up to max 4 lines")
            ],
          ),
        ),
        const SizedBox(
