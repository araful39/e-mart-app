  ...
  Widget build(BuildContext context) {
              ...
              Stack(
               children: [
                 ...
                 Row(
                   ...
                   children: [
                     Image(
                       image: AssetImage(productDetailController.sliderImages()),
                       height:180,
                     ),
   ...
   ListView.separated(
                      ...
                      itemBuilder: (context,index){
                        return  InkWell(
                          onTap:productDetailController.changeSliderImages(index)
                          ,
                          child: RRoundedImage(
                              ...
                              height: 50,
                              imageUrl: productDetailController.imagesList[index].toString(), isNetworkImage: false),
                        );
                      },
